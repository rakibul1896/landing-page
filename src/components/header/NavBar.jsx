  ...
  return (
    <div className="navFlex">
      ...
      <div className="navMenuContainer">
        <div
          className={value ? 'background' : 'background newBackground'}
        ></div>
        <div className={value ? 'navMenu' : 'navMenu newNavMenu'}>
          <a href="/">Pricing</a>
          <a href="/">Product</a>
          <a href="/">About Us</a>
          <a href="/">Careers</a>
        ...
        <div
          ...
          style={{ display: dropDownIcon ? 'block' : 'none' }}
        >
          <div
            className="hamburger"
